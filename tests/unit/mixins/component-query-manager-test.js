...
import ApolloQueryManager from 'ember-apollo-client/apollo/query-manager';
import ComponentQueryManagerMixin
  from 'dummy/mixins/apollo-component-query-manager';
import { moduleFor, test } from 'ember-qunit';

const { getOwner, Object: EmberObject } = Ember;

moduleFor(
  'mixin:apollo-component-query-manager',
  'Unit | Mixin | component query manager',
  {
    ...
    beforeEach() {
      ...
      this.register('object:apollo-query-manager', ApolloQueryManager);
    },
    subject() {
...
test('it unsubscribes from any watchQuery subscriptions', function(assert) {
  ...
  apolloService.set('managedWatchQuery', (opts, _resultKey, manager) => {
